...
class Webhook(models.Model):
    ...
    type_create = models.BooleanField(
        default=False, help_text="Call this webhook when a matching object is created."
    )
    type_update = models.BooleanField(
        default=False, help_text="Call this webhook when a matching object is updated."
    )
    type_delete = models.BooleanField(
        default=False, help_text="Call this webhook when a matching object is deleted."
    )
...
class ConfigContextModel(models.Model):
    ...
    def get_config_context(self):
        ...
        if not hasattr(self, "config_context_data"):
            ...
            config_context_data = ConfigContext.objects.get_for_object(
...
class JobResult(models.Model):
    ...
    def enqueue_job(cls, func, name, obj_type, user, *args, **kwargs):
        ...
        job_result = cls.objects.create(
            name=name, obj_type=obj_type, user=user, job_id=uuid.uuid4()
        )
