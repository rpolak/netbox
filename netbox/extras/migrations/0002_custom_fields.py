        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text=b"Name of the field as displayed to users (if not provided, the field's name will be used)",
                        max_length=50,
                    ),
                ),
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text=b'Default value for the field. Use "true" or "false" for booleans. N/A for selection fields.',
                        max_length=100,
                    ),
                ),
                (
                    ...
                    models.PositiveSmallIntegerField(
                        default=100,
                        help_text=b"Fields with higher weights appear lower in a form",
                    ),
                ),
                (
                    "obj_type",
                    models.ManyToManyField(
                        help_text=b"The object(s) to which this field applies.",
                        related_name="custom_fields",
                        to="contenttypes.ContentType",
                        verbose_name=b"Object(s)",
                    ),
                ),
            ],
            options={
