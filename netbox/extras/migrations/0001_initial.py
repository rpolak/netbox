    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "source",
                    models.CharField(max_length=500, verbose_name=b"Source URL"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "device_patterns",
                    models.TextField(
                        help_text=b"Identify devices to include in the diagram using regular expressions,one per line. Each line will result in a new tier of the drawing. Separate multiple regexes on a line using commas. Devices will be rendered in the order they are defined."
                    ),
                ),
