...
class CustomFieldTest(TestCase):
    ...
    def test_simple_fields(self):
        ...
        for data in DATA:
            ...
            cfv = CustomFieldValue.objects.filter(
                obj_type=obj_type, obj_id=site.pk
            ).first()
    ...
    def test_select_field(self):
        ...
        # Create a custom field
        cf = CustomField(
            type=CustomFieldTypeChoices.TYPE_SELECT, name="my_field", required=False
        )
        cf.save()
        cf.obj_type.set([obj_type])
        cf.save()
        ...
        cfv.save()
        self.assertEqual(
            CustomFieldValue.objects.filter(obj_type=obj_type, obj_id=site.pk).count(),
            0,
        )
...
class CustomFieldManagerTest(TestCase):
    def setUp(self):
        ...
        custom_field = CustomField(
            type=CustomFieldTypeChoices.TYPE_TEXT, name="text_field", default="foo"
        )
        custom_field.save()
...
class CustomFieldAPITest(APITestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.cf_integer = CustomField(
            type=CustomFieldTypeChoices.TYPE_INTEGER, name="number_field", default=123
        )
        cls.cf_integer.save()
        ...
        cls.cf_select = CustomField(
            type=CustomFieldTypeChoices.TYPE_SELECT, name="choice_field"
        )
        cls.cf_select.save()
    ...
    def test_get_single_object_with_custom_field_values(self):
        ...
        self.assertEqual(
            response.data["custom_fields"]["text_field"], site2_cfvs["text_field"]
        )
        self.assertEqual(
            response.data["custom_fields"]["number_field"], site2_cfvs["number_field"]
        )
        self.assertEqual(
            response.data["custom_fields"]["boolean_field"], site2_cfvs["boolean_field"]
        )
        self.assertEqual(
            response.data["custom_fields"]["date_field"], site2_cfvs["date_field"]
        )
        self.assertEqual(
            response.data["custom_fields"]["url_field"], site2_cfvs["url_field"]
        )
        self.assertEqual(
            response.data["custom_fields"]["choice_field"]["label"],
            self.cf_select_choice2.value,
        )
    ...
    def test_create_single_object_with_defaults(self):
        ...
        cfvs = {cfv.field.name: cfv.value for cfv in site.custom_field_values.all()}
    ...
    def test_create_multiple_objects_with_values(self):
        ...
        for i, obj in enumerate(data):
            ...
            self.assertEqual(
                response_cf["number_field"], custom_field_data["number_field"]
            )
            self.assertEqual(
                response_cf["boolean_field"], custom_field_data["boolean_field"]
            )
            ...
            self.assertEqual(
                response_cf["choice_field"], custom_field_data["choice_field"]
            )
    ...
    def test_update_single_object_with_values(self):
        ...
        self.assertEqual(
            site2_updated_cfvs["date_field"], site2_original_cfvs["date_field"]
        )
        self.assertEqual(
            site2_updated_cfvs["url_field"], site2_original_cfvs["url_field"]
        )
        self.assertEqual(
            site2_updated_cfvs["choice_field"], site2_original_cfvs["choice_field"]
        )
...
class CustomFieldChoiceAPITest(APITestCase):
    def setUp(self):
        ...
        self.cf_1 = CustomField.objects.create(
            name="cf_1", type=CustomFieldTypeChoices.TYPE_SELECT
        )
        self.cf_2 = CustomField.objects.create(
            name="cf_2", type=CustomFieldTypeChoices.TYPE_SELECT
        )

        self.cf_choice_1 = CustomFieldChoice.objects.create(
            field=self.cf_1, value="cf_field_1", weight=100
        )
        self.cf_choice_2 = CustomFieldChoice.objects.create(
            field=self.cf_1, value="cf_field_2", weight=50
        )
        self.cf_choice_3 = CustomFieldChoice.objects.create(
            field=self.cf_2, value="cf_field_3", weight=10
        )
    ...
    def test_list_cfc(self):
        ...
        self.assertEqual(
            self.cf_choice_1.pk, response.data[self.cf_1.name][self.cf_choice_1.value]
        )
        self.assertEqual(
            self.cf_choice_2.pk, response.data[self.cf_1.name][self.cf_choice_2.value]
        )
        self.assertEqual(
...
class CustomFieldImportTest(TestCase):
    ...
    def test_import(self):
        ...
        custom_field_values = {
            cf.name: value
            for cf, value in Site.objects.get(name="Site 1").get_custom_fields().items()
        }
        ...
        custom_field_values = {
            cf.name: value
            for cf, value in Site.objects.get(name="Site 2").get_custom_fields().items()
        }
        self.assertEqual(len(custom_field_values), 6)
        ...
        self.assertFalse(
            CustomFieldValue.objects.filter(obj_type=obj_type, obj_id=site3.pk).exists()
        )
