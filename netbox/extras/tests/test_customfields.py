...
class CustomFieldAPITest(APITestCase):
    ...
    def test_get_single_object_with_custom_field_data(self):
        ...
        self.assertEqual(
            response.data["custom_fields"]["choice_field"], site2_cfvs["choice_field"]
        )
    ...
    def test_create_single_object_with_defaults(self):
        ...
        self.assertEqual(
            site.custom_field_data["number_field"], self.cf_integer.default
        )
        self.assertEqual(
            site.custom_field_data["boolean_field"], self.cf_boolean.default
        )
        self.assertEqual(
            str(site.custom_field_data["date_field"]), self.cf_date.default
        )
    ...
    def test_create_single_object_with_values(self):
        ...
        self.assertEqual(
            site.custom_field_data["number_field"], data_cf["number_field"]
        )
        self.assertEqual(
            site.custom_field_data["boolean_field"], data_cf["boolean_field"]
        )
        self.assertEqual(
        ...
        self.assertEqual(
            site.custom_field_data["choice_field"], data_cf["choice_field"]
        )
    ...
    def test_create_multiple_objects_with_defaults(self):
        ...
        for i, obj in enumerate(data):
            ...
            self.assertEqual(site.custom_field_data["url_field"], self.cf_url.default)
            self.assertEqual(
                site.custom_field_data["choice_field"], self.cf_select.default
            )
    ...
    def test_create_multiple_objects_with_values(self):
        ...
        for i, obj in enumerate(data):
            ...
            site = Site.objects.get(pk=response.data[i]["id"])
            self.assertEqual(
                site.custom_field_data["text_field"], custom_field_data["text_field"]
            )
            self.assertEqual(
            ...
            self.assertEqual(
                site.custom_field_data["url_field"], custom_field_data["url_field"]
            )
            self.assertEqual(
    ...
    def test_update_single_object_with_values(self):
        ...
        self.assertEqual(
            response_cf["number_field"], data["custom_fields"]["number_field"]
        )
        ...
        site.refresh_from_db()
        self.assertEqual(
            site.custom_field_data["text_field"], data["custom_fields"]["text_field"]
        )
        self.assertEqual(
            site.custom_field_data["number_field"],
        ...
        self.assertEqual(
            site.custom_field_data["boolean_field"], original_cfvs["boolean_field"]
        )
        self.assertEqual(
            site.custom_field_data["date_field"], original_cfvs["date_field"]
        )
        self.assertEqual(
            site.custom_field_data["url_field"], original_cfvs["url_field"]
        )
        self.assertEqual(
            site.custom_field_data["choice_field"], original_cfvs["choice_field"]
        )
...
class CustomFieldModelTest(TestCase):
    ...
    def test_missing_required_field(self):
        ...
        """
        cf3 = CustomField(
            type=CustomFieldTypeChoices.TYPE_TEXT, name="baz", required=True
        )
        cf3.save()
...
class CustomFieldFilterTest(TestCase):
    ...
    def test_filter_date(self):
        self.assertEqual(
            self.filterset({"cf_cf5": "2016-06-26"}, self.queryset).qs.count(), 1
        )

    def test_filter_url(self):
        self.assertEqual(
            self.filterset(
                {"cf_cf6": "http://foo.example.com/"}, self.queryset
            ).qs.count(),
            1,
        )
        self.assertEqual(
            self.filterset({"cf_cf7": "example.com"}, self.queryset).qs.count(), 2
        )
