...
class ChangeLogViewTest(ModelViewTestCase):
    ...
    def setUpTestData(cls):
        ...
        cf = CustomField(
            type=CustomFieldTypeChoices.TYPE_TEXT, name="my_field", required=False
        )
        cf.save()
        cf.obj_type.set([ct])
    ...
    def test_delete_object(self):
        ...
        CustomFieldValue.objects.create(
            field=CustomField.objects.get(name="my_field"), obj=site, value="ABC"
        )
