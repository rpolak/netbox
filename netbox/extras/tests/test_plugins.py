...
@skipIf(
    "extras.tests.dummy_plugin" not in settings.PLUGINS,
...
class PluginTest(TestCase):
    def test_config(self):
        ...
        self.assertIn(
            "extras.tests.dummy_plugin.DummyPluginConfig", settings.INSTALLED_APPS
        )
    ...
    def test_middleware(self):
        ...
        """
        self.assertIn(
            "extras.tests.dummy_plugin.middleware.DummyMiddleware", settings.MIDDLEWARE
        )
