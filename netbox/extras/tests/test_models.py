...
class ConfigContextTest(TestCase):
    ...
    def setUp(self):
        ...
        self.site = Site.objects.create(
            name="Site-1", slug="site-1", region=self.region
        )
    ...
    def test_higher_weight_wins(self):
        ...
        context1 = ConfigContext(
            name="context 1", weight=101, data={"a": 123, "b": 456, "c": 777}
        )
        context2 = ConfigContext(
            name="context 2", weight=100, data={"a": 123, "b": 456, "c": 789}
        )
    ...
    def test_name_ordering_after_weight(self):
        ...
        context1 = ConfigContext(
            name="context 1", weight=100, data={"a": 123, "b": 456, "c": 777}
        )
        context2 = ConfigContext(
            name="context 2", weight=100, data={"a": 123, "b": 456, "c": 789}
        )
    ...
    def test_annotation_same_as_get_for_object_virtualmachine_relations(self):
        ...
        cluster = Cluster.objects.create(
            name="Cluster", group=cluster_group, type=cluster_type
        )
        cluster_context = ConfigContext.objects.create(
            name="cluster", weight=100, data={"cluster": 1}
        )
        ...
        annotated_queryset = VirtualMachine.objects.filter(
