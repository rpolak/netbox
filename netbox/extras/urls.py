...
urlpatterns = [
    ...
    path(
        "reports/results/<int:job_result_pk>/",
        views.ReportResultView.as_view(),
        name="report_result",
    ),
    # Scripts
    ...
    path(
        "scripts/results/<int:job_result_pk>/",
        views.ScriptResultView.as_view(),
        name="script_result",
    ),
]
