...
class GetReleasesTestCase(SimpleTestCase):
    ...
    def test_pre_releases(
        self, dummy_cache_get: Mock, dummy_cache_set: Mock, dummy_request_get: Mock
    ):
        ...
        self.assertListEqual(
            ...
            [
                ...
                (
                    Version("2.6b1"),
                    "https://github.com/netbox-community/netbox/releases/tag/v2.6-beta1",
                ),
                (
                    Version("2.5.9"),
                    "https://github.com/netbox-community/netbox/releases/tag/v2.5.9",
                ),
            ],
        )
