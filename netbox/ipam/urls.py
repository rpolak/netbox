...
urlpatterns = [
    ...
    # Route targets
    path(
        "route-targets/", views.RouteTargetListView.as_view(), name="routetarget_list"
    ),
    path(
        "route-targets/add/",
    ...
    path(
        "route-targets/<int:pk>/", views.RouteTargetView.as_view(), name="routetarget"
    ),
    path(
        "route-targets/<int:pk>/edit/",
        views.RouteTargetEditView.as_view(),
        name="routetarget_edit",
    ),
    path(
        "route-targets/<int:pk>/delete/",
        views.RouteTargetDeleteView.as_view(),
        name="routetarget_delete",
    ),
    path(
        "route-targets/<int:pk>/changelog/",
        ObjectChangeLogView.as_view(),
    ...
    path(
        "roles/<slug:slug>/delete/", views.RoleDeleteView.as_view(), name="role_delete"
    ),
    path(
    ...
    path(
        "prefixes/import/", views.PrefixBulkImportView.as_view(), name="prefix_import"
    ),
    ...
    path(
        "ip-addresses/<int:pk>/edit/",
        views.IPAddressEditView.as_view(),
        name="ipaddress_edit",
    ),
    path(
        "ip-addresses/<int:pk>/delete/",
    ...
    path(
        "vlan-groups/<int:pk>/edit/",
        views.VLANGroupEditView.as_view(),
        name="vlangroup_edit",
    ),
    path(
        "vlan-groups/<int:pk>/delete/",
        views.VLANGroupDeleteView.as_view(),
        name="vlangroup_delete",
    ),
    path(
        "vlan-groups/<int:pk>/vlans/",
        views.VLANGroupVLANsView.as_view(),
        name="vlangroup_vlans",
    ),
    path(
        "vlan-groups/<int:pk>/changelog/",
        ObjectChangeLogView.as_view(),
    ...
    path(
        "services/import/", views.ServiceBulkImportView.as_view(), name="service_import"
    ),
    path(
        "services/edit/", views.ServiceBulkEditView.as_view(), name="service_bulk_edit"
    ),
    path(
        "services/delete/",
    ...
    path(
        "services/<int:pk>/edit/", views.ServiceEditView.as_view(), name="service_edit"
    ),
    path(
