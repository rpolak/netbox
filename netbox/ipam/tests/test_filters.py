...
class PrefixTestCase(TestCase):
    ...
    def test_status(self):
        params = {
            "status": [
                PrefixStatusChoices.STATUS_DEPRECATED,
...
class IPAddressTestCase(TestCase):
    ...
    def test_role(self):
        params = {
            "role": [IPAddressRoleChoices.ROLE_SECONDARY, IPAddressRoleChoices.ROLE_VIP]
        }
        self.assertEqual(self.filterset(params, self.queryset).qs.count(), 4)
...
class VLANGroupTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        vlan_groups = (
            VLANGroup(
                name="VLAN Group 1", slug="vlan-group-1", site=sites[0], description="A"
            ),
            VLANGroup(
                name="VLAN Group 2", slug="vlan-group-2", site=sites[1], description="B"
            ),
            VLANGroup(
                name="VLAN Group 3", slug="vlan-group-3", site=sites[2], description="C"
            ),
...
class VLANTestCase(TestCase):
    ...
    def test_status(self):
        params = {
            "status": [
                VLANStatusChoices.STATUS_ACTIVE,
                VLANStatusChoices.STATUS_DEPRECATED,
            ]
        }
        self.assertEqual(self.filterset(params, self.queryset).qs.count(), 4)
