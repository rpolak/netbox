...
urlpatterns = [
    ...
    # Circuit types
    path(
        "circuit-types/", views.CircuitTypeListView.as_view(), name="circuittype_list"
    ),
    path(
        "circuit-types/add/",
    ...
    path(
        "circuits/import/", views.CircuitBulkImportView.as_view(), name="circuit_import"
    ),
    path(
        "circuits/edit/", views.CircuitBulkEditView.as_view(), name="circuit_bulk_edit"
    ),
    path(
        "circuits/delete/",
    ...
    path(
        "circuits/<int:pk>/edit/", views.CircuitEditView.as_view(), name="circuit_edit"
    ),
    path(
