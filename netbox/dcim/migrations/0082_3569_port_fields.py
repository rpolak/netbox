...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunPython(code=frontporttemplate_type_to_slug),
        ...
        migrations.RunPython(code=rearporttemplate_type_to_slug),
        # FrontPort.type
        migrations.AlterField(
        ...
        migrations.RunPython(code=frontport_type_to_slug),
        # RearPort.type
        migrations.AlterField(
            model_name="rearport",
            name="type",
        ...
        migrations.RunPython(code=rearport_type_to_slug),
    ]
