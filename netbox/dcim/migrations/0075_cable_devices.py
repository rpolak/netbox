...
def cache_cable_devices(apps, schema_editor):
    ...
    for i, cable in enumerate(Cable.objects.all(), start=1):
        ...
        termination_a_model = apps.get_model(
            cable.termination_a_type.app_label, cable.termination_a_type.model
        )
        ...
        termination_b_model = apps.get_model(
            cable.termination_b_type.app_label, cable.termination_b_type.model
        )
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunPython(
            code=cache_cable_devices, reverse_code=migrations.RunPython.noop
        ),
    ]
