...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunPython(
            code=naturalize_sites, reverse_code=migrations.RunPython.noop
        ),
        migrations.RunPython(
            code=naturalize_racks, reverse_code=migrations.RunPython.noop
        ),
        migrations.RunPython(
            code=naturalize_devices, reverse_code=migrations.RunPython.noop
        ),
    ]
