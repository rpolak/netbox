...
def _update_model_names(model):
    ...
    for name in (
        ...
        model.objects.filter(name=name).update(
            _name=utilities.ordering.naturalize_interface(name, max_length=100)
        )
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=utilities.fields.NaturalOrderingField(
                ...
                blank=True,
                max_length=100,
                naturalize_function=utilities.ordering.naturalize_interface,
            ),
        ),
        migrations.AddField(
        ...
        migrations.RunPython(
            code=naturalize_interfacetemplates, reverse_code=migrations.RunPython.noop
        ),
        migrations.RunPython(
            code=naturalize_interfaces, reverse_code=migrations.RunPython.noop
        ),
    ]
