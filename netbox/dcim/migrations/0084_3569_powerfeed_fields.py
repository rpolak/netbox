...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunPython(code=powerfeed_status_to_slug),
        # PowerFeed.type
        migrations.AlterField(
            model_name="powerfeed",
            name="type",
        ...
        migrations.RunPython(code=powerfeed_type_to_slug),
        # PowerFeed.supply
        migrations.AlterField(
            model_name="powerfeed",
            name="supply",
        ...
        migrations.RunPython(code=powerfeed_supply_to_slug),
        # PowerFeed.phase
        migrations.AlterField(
            model_name="powerfeed",
            name="phase",
        ...
        migrations.RunPython(code=powerfeed_phase_to_slug),
    ]
