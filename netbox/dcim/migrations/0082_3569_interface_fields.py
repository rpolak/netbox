...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunPython(code=interfacetemplate_type_to_slug),
        # Interface.type
        migrations.AlterField(
        ...
        migrations.RunPython(code=interface_type_to_slug),
        # Interface.mode
        migrations.AlterField(
            model_name="interface",
            name="mode",
        ...
        migrations.RunPython(code=interface_mode_to_slug),
        migrations.AlterField(
            model_name="interface",
            name="mode",
