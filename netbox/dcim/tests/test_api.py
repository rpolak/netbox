    ...
    class ComponentTraceMixin(APITestCase):
        ...
        def test_trace(self):
            ...
            peer_obj = self.peer_termination_type.objects.create(
                device=peer_device, name="Peer Termination"
            )
            ...
            url = reverse(
                f"dcim-api:{self.model._meta.model_name}-trace", kwargs={"pk": obj.pk}
            )
    ...
    def setUpTestData(cls):
        ...
        parent_rack_groups = (
            RackGroup.objects.create(
                site=sites[0], name="Parent Rack Group 1", slug="parent-rack-group-1"
            ),
            RackGroup.objects.create(
                site=sites[1], name="Parent Rack Group 2", slug="parent-rack-group-2"
            ),
        )
...
class RackTest(APIViewTestCases.APIViewTestCase):
    ...
    def setUpTestData(cls):
        ...
        rack_groups = (
            RackGroup.objects.create(
                site=sites[0], name="Rack Group 1", slug="rack-group-1"
            ),
            RackGroup.objects.create(
                site=sites[1], name="Rack Group 2", slug="rack-group-2"
            ),
        )
        ...
        racks = (
            Rack(
                site=sites[0], group=rack_groups[0], role=rack_roles[0], name="Rack 1"
            ),
            Rack(
                site=sites[0], group=rack_groups[0], role=rack_roles[0], name="Rack 2"
            ),
            Rack(
                site=sites[0], group=rack_groups[0], role=rack_roles[0], name="Rack 3"
            ),
        )
    ...
    def test_get_rack_elevation_svg(self):
        ...
        rack = Rack.objects.first()
        self.add_permissions("dcim.view_rack")
        url = "{}?render=svg".format(
            reverse("dcim-api:rack-elevation", kwargs={"pk": rack.pk})
        )
...
class ConsoleServerPortTemplateTest(APIViewTestCases.APIViewTestCase):
    ...
    def setUpTestData(cls):
        ...
        console_server_port_templates = (
            ConsoleServerPortTemplate(
                device_type=devicetype, name="Console Server Port Template 1"
            ),
            ConsoleServerPortTemplate(
                device_type=devicetype, name="Console Server Port Template 2"
            ),
            ConsoleServerPortTemplate(
                device_type=devicetype, name="Console Server Port Template 3"
            ),
        )
...
class InterfaceTemplateTest(APIViewTestCases.APIViewTestCase):
    ...
    def setUpTestData(cls):
        ...
        interface_templates = (
            InterfaceTemplate(
                device_type=devicetype, name="Interface Template 1", type="1000base-t"
            ),
            InterfaceTemplate(
                device_type=devicetype, name="Interface Template 2", type="1000base-t"
            ),
            InterfaceTemplate(
                device_type=devicetype, name="Interface Template 3", type="1000base-t"
            ),
        )
...
class ConnectedDeviceTest(APITestCase):
    ...
    def test_get_connected_device(self):
        ...
        response = self.client.get(
            url + "?peer_device=TestDevice2&peer_interface=eth0", **self.header
        )
...
class VirtualChassisTest(APIViewTestCases.APIViewTestCase):
    ...
    def setUpTestData(cls):
        ...
        devicetype = DeviceType.objects.create(
            manufacturer=manufacturer, model="Device Type", slug="device-type"
        )
        devicerole = DeviceRole.objects.create(
            name="Device Role", slug="device-role", color="ff0000"
        )
        ...
        virtual_chassis = (
            VirtualChassis(
                name="Virtual Chassis 1", master=devices[0], domain="domain-1"
            ),
            VirtualChassis(
                name="Virtual Chassis 2", master=devices[3], domain="domain-2"
            ),
            VirtualChassis(
                name="Virtual Chassis 3", master=devices[6], domain="domain-3"
            ),
        )
...
class PowerFeedTest(APIViewTestCases.APIViewTestCase):
    ...
    def setUpTestData(cls):
        site = Site.objects.create(name="Site 1", slug="site-1")
        rackgroup = RackGroup.objects.create(
            site=site, name="Rack Group 1", slug="rack-group-1"
        )
        rackrole = RackRole.objects.create(
            name="Rack Role 1", slug="rack-role-1", color="ff0000"
        )
