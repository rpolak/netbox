...
class PlatformTestCase(ViewTestCases.OrganizationalObjectViewTestCase):
    ...
    def setUpTestData(cls):
        ...
        Platform.objects.bulk_create(
            [
                Platform(
                    name="Platform 1", slug="platform-1", manufacturer=manufacturer
                ),
                Platform(
                    name="Platform 2", slug="platform-2", manufacturer=manufacturer
                ),
                Platform(
                    name="Platform 3", slug="platform-3", manufacturer=manufacturer
                ),
            ]
        )
...
class DeviceTestCase(ViewTestCases.PrimaryObjectViewTestCase):
    ...
    def setUpTestData(cls):
        ...
        devicetypes = (
            ...
            DeviceType(
                model="Device Type 2", slug="device-type-2", manufacturer=manufacturer
            ),
        )
        DeviceType.objects.bulk_create(devicetypes)
...
class VirtualChassisTestCase(ViewTestCases.PrimaryObjectViewTestCase):
    ...
    def setUpTestData(cls):
        ...
        vc1 = VirtualChassis.objects.create(
            name="VC1", master=devices[0], domain="domain-1"
        )
        ...
        vc2 = VirtualChassis.objects.create(
            name="VC2", master=devices[3], domain="domain-2"
        )
        ...
        vc3 = VirtualChassis.objects.create(
            name="VC3", master=devices[6], domain="domain-3"
        )
...
class PowerPanelTestCase(ViewTestCases.PrimaryObjectViewTestCase):
    ...
    def setUpTestData(cls):
        ...
        PowerPanel.objects.bulk_create(
            (
                PowerPanel(
                    site=sites[0], rack_group=rackgroups[0], name="Power Panel 1"
                ),
                PowerPanel(
                    site=sites[0], rack_group=rackgroups[0], name="Power Panel 2"
                ),
                PowerPanel(
                    site=sites[0], rack_group=rackgroups[0], name="Power Panel 3"
                ),
            )
        )
...
class PowerFeedTestCase(ViewTestCases.PrimaryObjectViewTestCase):
    ...
    def setUpTestData(cls):
        ...
        PowerFeed.objects.bulk_create(
            (
                PowerFeed(
                    name="Power Feed 1", power_panel=powerpanels[0], rack=racks[0]
                ),
                PowerFeed(
                    name="Power Feed 2", power_panel=powerpanels[0], rack=racks[0]
                ),
                PowerFeed(
                    name="Power Feed 3", power_panel=powerpanels[0], rack=racks[0]
                ),
            )
        )
