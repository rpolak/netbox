...
class SiteFilterSet(
    BaseFilterSet, TenancyFilterSet, CustomFieldModelFilterSet, CreatedUpdatedFilterSet
):
    ...
    status = django_filters.MultipleChoiceFilter(
        choices=SiteStatusChoices, null_value=None
    )
...
class RackFilterSet(
    ...
    status = django_filters.MultipleChoiceFilter(
        choices=RackStatusChoices, null_value=None
    )
...
class RackReservationFilterSet(
    BaseFilterSet, TenancyFilterSet, CustomFieldModelFilterSet
):
    q = django_filters.CharFilter(
        method="search",
        label="Search",
...
class DeviceTypeFilterSet(
    ...
    def _pass_through_ports(self, queryset, name, value):
        return queryset.exclude(
            frontporttemplates__isnull=value, rearporttemplates__isnull=value
        )
...
class DeviceFilterSet(
    ...
    status = django_filters.MultipleChoiceFilter(
        choices=DeviceStatusChoices, null_value=None
    )
...
class CableTerminationFilterSet(django_filters.FilterSet):
    cabled = django_filters.BooleanFilter(
        field_name="cable", lookup_expr="isnull", exclude=True
    )
...
class ConsolePortFilterSet(
    ...
    type = django_filters.MultipleChoiceFilter(
        choices=ConsolePortTypeChoices, null_value=None
    )
...
class PowerPortFilterSet(
    ...
    type = django_filters.MultipleChoiceFilter(
        choices=PowerPortTypeChoices, null_value=None
    )
...
class PowerOutletFilterSet(
    ...
    type = django_filters.MultipleChoiceFilter(
        choices=PowerOutletTypeChoices, null_value=None
    )
...
class InterfaceFilterSet(
    ...
    type = django_filters.MultipleChoiceFilter(
        choices=InterfaceTypeChoices, null_value=None
    )
...
class FrontPortFilterSet(
    BaseFilterSet, DeviceComponentFilterSet, CableTerminationFilterSet
):
    class Meta:
        model = FrontPort
...
class CableFilterSet(BaseFilterSet):
    ...
    rack_id = MultiValueNumberFilter(
        method="filter_device", field_name="device__rack_id"
    )
    rack = MultiValueNumberFilter(
        method="filter_device", field_name="device__rack__name"
    )
    site_id = MultiValueNumberFilter(
        method="filter_device", field_name="device__site_id"
    )
    site = MultiValueNumberFilter(
        method="filter_device", field_name="device__site__slug"
    )
    tenant_id = MultiValueNumberFilter(
        method="filter_device", field_name="device__tenant_id"
    )
    tenant = MultiValueNumberFilter(
        method="filter_device", field_name="device__tenant__slug"
    )
    tag = TagFilter()
