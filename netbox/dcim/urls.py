...
urlpatterns = [
    ...
    path(
        "sites/<slug:slug>/delete/", views.SiteDeleteView.as_view(), name="site_delete"
    ),
    path(
    ...
    path(
        "sites/<int:object_id>/images/add/",
    ...
    path(
        "racks/<int:pk>/changelog/",
        ObjectChangeLogView.as_view(),
        name="rack_changelog",
        kwargs={"model": Rack},
    ),
    path(
        "racks/<int:object_id>/images/add/",
        ImageAttachmentEditView.as_view(),
        name="rack_add_image",
        kwargs={"model": Rack},
    ),
    # Manufacturers
    path(
        "manufacturers/", views.ManufacturerListView.as_view(), name="manufacturer_list"
    ),
    path(
        "manufacturers/add/",
    ...
    path(
        "device-types/add/", views.DeviceTypeEditView.as_view(), name="devicetype_add"
    ),
    path(
        "device-types/import/",
    ...
    path(
        "console-port-templates/<int:pk>/edit/",
        views.ConsolePortTemplateEditView.as_view(),
        name="consoleporttemplate_edit",
    ),
    path(
        "console-port-templates/<int:pk>/delete/",
    ...
    path(
        "console-server-port-templates/<int:pk>/edit/",
        views.ConsoleServerPortTemplateEditView.as_view(),
        name="consoleserverporttemplate_edit",
    ),
    path(
        "console-server-port-templates/<int:pk>/delete/",
    ...
    path(
        "power-port-templates/<int:pk>/edit/",
        views.PowerPortTemplateEditView.as_view(),
        name="powerporttemplate_edit",
    ),
    path(
        "power-port-templates/<int:pk>/delete/",
    ...
    path(
        "power-outlet-templates/<int:pk>/edit/",
        views.PowerOutletTemplateEditView.as_view(),
        name="poweroutlettemplate_edit",
    ),
    path(
        "power-outlet-templates/<int:pk>/delete/",
    ...
    path(
        "front-port-templates/<int:pk>/edit/",
        views.FrontPortTemplateEditView.as_view(),
        name="frontporttemplate_edit",
    ),
    path(
        "front-port-templates/<int:pk>/delete/",
    ...
    path(
        "rear-port-templates/<int:pk>/edit/",
        views.RearPortTemplateEditView.as_view(),
        name="rearporttemplate_edit",
    ),
    path(
        "rear-port-templates/<int:pk>/delete/",
    ...
    path(
        "device-bay-templates/<int:pk>/edit/",
        views.DeviceBayTemplateEditView.as_view(),
        name="devicebaytemplate_edit",
    ),
    path(
        "device-bay-templates/<int:pk>/delete/",
    ...
    path(
        "device-roles/add/", views.DeviceRoleEditView.as_view(), name="devicerole_add"
    ),
    path(
        "device-roles/import/",
    ...
    path(
        "devices/<int:pk>/status/",
        views.DeviceStatusView.as_view(),
        name="device_status",
    ),
    path(
        "devices/<int:pk>/lldp-neighbors/",
    ...
    path(
        "devices/<int:device>/services/assign/",
        ServiceEditView.as_view(),
        name="device_service_assign",
    ),
    path(
        "devices/<int:object_id>/images/add/",
        ImageAttachmentEditView.as_view(),
    ...
    # Console ports
    path(
        "console-ports/", views.ConsolePortListView.as_view(), name="consoleport_list"
    ),
    path(
        "console-ports/add/",
    ...
    path(
        "console-ports/<int:pk>/", views.ConsolePortView.as_view(), name="consoleport"
    ),
    path(
        "console-ports/<int:pk>/edit/",
        views.ConsolePortEditView.as_view(),
        name="consoleport_edit",
    ),
    path(
        "console-ports/<int:pk>/delete/",
        views.ConsolePortDeleteView.as_view(),
        name="consoleport_delete",
    ),
    path(
        "console-ports/<int:pk>/changelog/",
        ObjectChangeLogView.as_view(),
        name="consoleport_changelog",
        kwargs={"model": ConsolePort},
    ),
    path(
        "console-ports/<int:pk>/trace/",
        views.PathTraceView.as_view(),
        name="consoleport_trace",
        kwargs={"model": ConsolePort},
    ),
    path(
        "console-ports/<int:termination_a_id>/connect/<str:termination_b_type>/",
    ...
    path(
        "power-ports/<int:pk>/edit/",
        views.PowerPortEditView.as_view(),
        name="powerport_edit",
    ),
    path(
        "power-ports/<int:pk>/delete/",
        views.PowerPortDeleteView.as_view(),
        name="powerport_delete",
    ),
    path(
        "power-ports/<int:pk>/changelog/",
        ObjectChangeLogView.as_view(),
        name="powerport_changelog",
        kwargs={"model": PowerPort},
    ),
    path(
        "power-ports/<int:pk>/trace/",
        views.PathTraceView.as_view(),
        name="powerport_trace",
        kwargs={"model": PowerPort},
    ),
    path(
        "power-ports/<int:termination_a_id>/connect/<str:termination_b_type>/",
        views.CableCreateView.as_view(),
    ...
    # Power outlets
    path(
        "power-outlets/", views.PowerOutletListView.as_view(), name="poweroutlet_list"
    ),
    path(
        "power-outlets/add/",
    ...
    path(
        "power-outlets/<int:pk>/", views.PowerOutletView.as_view(), name="poweroutlet"
    ),
    path(
        "power-outlets/<int:pk>/edit/",
        views.PowerOutletEditView.as_view(),
        name="poweroutlet_edit",
    ),
    path(
        "power-outlets/<int:pk>/delete/",
        views.PowerOutletDeleteView.as_view(),
        name="poweroutlet_delete",
    ),
    path(
        "power-outlets/<int:pk>/changelog/",
        ObjectChangeLogView.as_view(),
        name="poweroutlet_changelog",
        kwargs={"model": PowerOutlet},
    ),
    path(
        "power-outlets/<int:pk>/trace/",
        views.PathTraceView.as_view(),
        name="poweroutlet_trace",
        kwargs={"model": PowerOutlet},
    ),
    path(
        "power-outlets/<int:termination_a_id>/connect/<str:termination_b_type>/",
        views.CableCreateView.as_view(),
    ...
    path(
        "interfaces/<int:pk>/edit/",
        views.InterfaceEditView.as_view(),
        name="interface_edit",
    ),
    path(
        "interfaces/<int:pk>/delete/",
        views.InterfaceDeleteView.as_view(),
        name="interface_delete",
    ),
    path(
        "interfaces/<int:pk>/changelog/",
        ObjectChangeLogView.as_view(),
        name="interface_changelog",
        kwargs={"model": Interface},
    ),
    path(
        "interfaces/<int:pk>/trace/",
        views.PathTraceView.as_view(),
        name="interface_trace",
        kwargs={"model": Interface},
    ),
    path(
        "interfaces/<int:termination_a_id>/connect/<str:termination_b_type>/",
        views.CableCreateView.as_view(),
    ...
    path(
        "front-ports/<int:pk>/edit/",
        views.FrontPortEditView.as_view(),
        name="frontport_edit",
    ),
    path(
        "front-ports/<int:pk>/delete/",
        views.FrontPortDeleteView.as_view(),
        name="frontport_delete",
    ),
    path(
        "front-ports/<int:pk>/changelog/",
        ObjectChangeLogView.as_view(),
        name="frontport_changelog",
        kwargs={"model": FrontPort},
    ),
    path(
        "front-ports/<int:pk>/trace/",
        views.PathTraceView.as_view(),
        name="frontport_trace",
        kwargs={"model": FrontPort},
    ),
    path(
        "front-ports/<int:termination_a_id>/connect/<str:termination_b_type>/",
        views.CableCreateView.as_view(),
    ...
    path(
        "rear-ports/<int:pk>/edit/",
        views.RearPortEditView.as_view(),
        name="rearport_edit",
    ),
    path(
        "rear-ports/<int:pk>/delete/",
        views.RearPortDeleteView.as_view(),
        name="rearport_delete",
    ),
    path(
        "rear-ports/<int:pk>/changelog/",
        ObjectChangeLogView.as_view(),
        name="rearport_changelog",
        kwargs={"model": RearPort},
    ),
    path(
        "rear-ports/<int:pk>/trace/",
        views.PathTraceView.as_view(),
        name="rearport_trace",
        kwargs={"model": RearPort},
    ),
    path(
        "rear-ports/<int:termination_a_id>/connect/<str:termination_b_type>/",
        views.CableCreateView.as_view(),
    ...
    path(
        "inventory-items/<int:pk>/changelog/",
        ObjectChangeLogView.as_view(),
    ...
    path(
        "cables/delete/", views.CableBulkDeleteView.as_view(), name="cable_bulk_delete"
    ),
    path("cables/<int:pk>/", views.CableView.as_view(), name="cable"),
    path("cables/<int:pk>/edit/", views.CableEditView.as_view(), name="cable_edit"),
    path(
        "cables/<int:pk>/delete/", views.CableDeleteView.as_view(), name="cable_delete"
    ),
    path(
        "cables/<int:pk>/changelog/",
        ObjectChangeLogView.as_view(),
    ...
    path(
        "power-panels/add/", views.PowerPanelEditView.as_view(), name="powerpanel_add"
    ),
    path(
        "power-panels/import/",
    ...
    path(
        "power-feeds/<int:pk>/edit/",
        views.PowerFeedEditView.as_view(),
        name="powerfeed_edit",
    ),
    path(
        "power-feeds/<int:pk>/delete/",
        views.PowerFeedDeleteView.as_view(),
        name="powerfeed_delete",
    ),
    path(
        "power-feeds/<int:pk>/trace/",
        views.PathTraceView.as_view(),
        name="powerfeed_trace",
        kwargs={"model": PowerFeed},
    ),
    path(
        "power-feeds/<int:pk>/changelog/",
        ObjectChangeLogView.as_view(),
        name="powerfeed_changelog",
        kwargs={"model": PowerFeed},
    ),
    path(
        "power-feeds/<int:termination_a_id>/connect/<str:termination_b_type>/",
        views.CableCreateView.as_view(),
