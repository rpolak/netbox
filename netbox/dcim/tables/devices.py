...
class DeviceRoleTable(BaseTable):
    ...
    device_count = LinkedCountColumn(
        viewname="dcim:device_list", url_params={"role": "slug"}, verbose_name="Devices"
    )
...
class DeviceConsolePortTable(ConsolePortTable):
    ...
    class Meta(DeviceComponentTable.Meta):
        ...
        row_attrs = {
            "class": lambda record: record.cable.get_status_class()
            if record.cable
            else ""
        }
...
class DevicePowerPortTable(PowerPortTable):
    ...
    actions = ButtonsColumn(
        model=PowerPort, buttons=("edit", "delete"), prepend_template=POWERPORT_BUTTONS
    )
...
class DeviceInterfaceTable(InterfaceTable):
    ...
    actions = ButtonsColumn(
        model=Interface, buttons=("edit", "delete"), prepend_template=INTERFACE_BUTTONS
    )
...
class DeviceFrontPortTable(FrontPortTable):
    ...
    actions = ButtonsColumn(
        model=FrontPort, buttons=("edit", "delete"), prepend_template=FRONTPORT_BUTTONS
    )
...
class DeviceRearPortTable(RearPortTable):
    ...
    actions = ButtonsColumn(
        model=RearPort, buttons=("edit", "delete"), prepend_template=REARPORT_BUTTONS
    )
...
class DeviceDeviceBayTable(DeviceBayTable):
    ...
    actions = ButtonsColumn(
        model=DeviceBay, buttons=("edit", "delete"), prepend_template=DEVICEBAY_BUTTONS
    )
