...
class ClusterGroupTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cluster_groups = (
            ClusterGroup(
                name="Cluster Group 1", slug="cluster-group-1", description="A"
            ),
            ClusterGroup(
                name="Cluster Group 2", slug="cluster-group-2", description="B"
            ),
            ClusterGroup(
                name="Cluster Group 3", slug="cluster-group-3", description="C"
            ),
        )
    ...
    def test_status(self):
        params = {
            "status": [
                ...
                VirtualMachineStatusChoices.STATUS_STAGED,
            ]
        }
        self.assertEqual(self.filterset(params, self.queryset).qs.count(), 2)
