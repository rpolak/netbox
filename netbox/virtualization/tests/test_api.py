...
class VirtualMachineTest(APIViewTestCases.APIViewTestCase):
    ...
    def setUpTestData(cls):
        ...
        clustergroup = ClusterGroup.objects.create(
            name="Cluster Group 1", slug="cluster-group-1"
        )
    ...
    def test_config_context_included_by_default_in_list_view(self):
        ...
        url = "{}?id={}".format(
            reverse("virtualization-api:virtualmachine-list"), virtualmachine.pk
        )
    ...
    def test_config_context_excluded(self):
        ...
        """
        url = (
            reverse("virtualization-api:virtualmachine-list")
...
class VMInterfaceTest(APIViewTestCases.APIViewTestCase):
    ...
    def setUpTestData(cls):
        ...
        virtualmachine = VirtualMachine.objects.create(
            cluster=cluster, name="Test VM 1"
        )
