...
urlpatterns = [
    # Cluster types
    path(
        "cluster-types/", views.ClusterTypeListView.as_view(), name="clustertype_list"
    ),
    path(
        "cluster-types/add/",
    ...
    path(
        "clusters/import/", views.ClusterBulkImportView.as_view(), name="cluster_import"
    ),
    path(
        "clusters/edit/", views.ClusterBulkEditView.as_view(), name="cluster_bulk_edit"
    ),
    path(
        "clusters/delete/",
    ...
    path(
        "clusters/<int:pk>/edit/", views.ClusterEditView.as_view(), name="cluster_edit"
    ),
    path(
    ...
    path(
        "interfaces/add/", views.VMInterfaceCreateView.as_view(), name="vminterface_add"
    ),
    path(
        "interfaces/import/",
